...
public class ExpenseService {
    ...
    public Expense createExpense(String description, BigDecimal amount, MultipartFile receipt,
        ...
        ExpenseService delegate = (self != null ? self : this);
        return delegate.createExpense(description, amount, receipt, username, category, expenseDate, false);
    }
    ...
    public Expense submitExpense(Long expenseId, String username) {
        ...
        if (!expense.getUser().getUsername().equals(username)) {
            throw new SecurityException("User is not authorized to submit this expense");
        }
