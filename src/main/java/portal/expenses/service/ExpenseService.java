...
public class ExpenseService {
    ...
    @Autowired
    @Lazy
    public void setSelf(ExpenseService self) {
        this.self = self;
    }
    ...
    public Expense createExpense(String description, BigDecimal amount, MultipartFile receipt,
        ...
        ExpenseService targetService = self != null ? self : this;
        return targetService.createExpense(description, amount, receipt, username, category, expenseDate, false);
    }
