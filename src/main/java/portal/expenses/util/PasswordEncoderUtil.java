...
public class PasswordEncoderUtil {
    ...
    public static void main(String[] args) {
        ...
        String employeePassword = args.length > 0 ? args[0] : "employee_pwd";
        String managerPassword = args.length > 1 ? args[1] : "manager_pwd";
        String financePassword = args.length > 2 ? args[2] : "finance_pwd";
