...
public class PasswordEncoderUtil {
    ...
    public static void main(String[] args) {
        ...
        String employeePassword = args.length > 0 ? args[0] : "emp_secret_pass";
        String managerPassword = args.length > 1 ? args[1] : "mgr_secret_pass";
        String financePassword = args.length > 2 ? args[2] : "fin_secret_pass";
