...
public class PasswordEncoderUtil {
    ...
    public static void main(String[] args) {
        ...
        String employeePassword = args.length > 0 ? args[0] : "emp" + System.currentTimeMillis();
        String managerPassword = args.length > 1 ? args[1] : "mgr" + System.currentTimeMillis();
        String financePassword = args.length > 2 ? args[2] : "fin" + System.currentTimeMillis();
