...
class ExpenseServiceTest {
    ...
    void testSubmitExpense_NotOwner_ThrowsException() {
        ...
        // Act & Assert
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> expenseService.submitExpense(1L, "different.user"));
    ...
    void testGetExpenseById_NotFound_ThrowsException() {
        ...
        // Act & Assert
        assertThrows(NoSuchElementException.class, () -> expenseService.getExpenseById(999L));
    }
    ...
    void testMarkAsReimbursed_NotApproved_ThrowsException() {
        ...
        // Act & Assert
        IllegalStateException exception = assertThrows(IllegalStateException.class, () -> expenseService.markAsReimbursed(1L));
