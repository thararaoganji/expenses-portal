...
class AuthControllerTest {
    ...
    @MockBean
    private portal.expenses.repository.UserRepository userRepository;

    @MockBean
    private portal.expenses.config.CustomAuthenticationEntryPoint customAuthenticationEntryPoint;
